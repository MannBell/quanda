        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title"><i className="fas fa-user-tie me-2"></i>Guest</h5>
              <button
            ...
            <div className="modal-footer">
              <button
                onClick={()=>{
                  this.props.signIn({ email:"guest@example.com", password:"123456" });
                  this.setState({ loading:true });
                }}
                className="mx-auto btn-lg btn btn-info text-dark"
              >
                Sign In As Guest
                {
                  this.state.loading
