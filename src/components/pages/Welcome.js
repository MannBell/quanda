    ...
    return (
      <main className="my-5">
        ...
        <section
          ...
          style={{background: "linear-gradient(to top, var(--bs-info), #0000)"}}
        >
          <div className="container">
            <div className="row align-items-center justify-content-between">
              ...
              <div className="col-md text-center text-md-start">
                <h1 style={{height:"7rem"}} className="mb-5 text-info">
                  Quanda<i className="fas fa-comments"></i><br/>
                </h1>
                <h2 style={{height:"5rem"}} className="text-light mb-4">
                  <span ref={ (el) => { this.typedEl = el; } }></span>
                </h2>
                <Link to="/signup" className="btn btn-lg btn-dark text-info">
                  Sign Up
                </Link>
              </div>
            </div>
